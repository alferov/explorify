...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapNodes = function mapNodes(node) {
	...
	var normalizeResponses = function normalizeResponses(responses) {
	  return responses.reduce(function (prev, curr) {
	    if (!curr) return prev;
	...
	var extend = function () {
	  var _ref4 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee4() {
	    var nodes, repositories, result;
	    return _regenerator2.default.wrap(function _callee4$(_context4) {
	      while (1) {
	        switch (_context4.prev = _context4.next) {
	          case 0:
	            nodes = (0, _from2.default)(getFeedItems());
	            repositories = new _set2.default(nodes.map(mapNodes));
	            _context4.next = 4;
